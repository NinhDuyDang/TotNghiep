...
public class RegisterController {
    ...
    /**
     * chuyển hướng đến trang veef thông tin xác thực email
     *
    ...
    public String confirmToken(@RequestParam("token") String token, RedirectAttributes redirectAttributes) {
        System.out.println("bấm vào link trong email gọi towis hàm này");
     ...
     *
     * @return trang nhập email kèm thông baos lỗi nếu không tìm thấy email
